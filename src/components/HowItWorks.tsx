...
const HowItWorks = () => {
  return (
    <section className="py-12 md:py-20 lg:py-24 px-4 bg-gradient-to-b from-primary/5 via-accent/8 to-secondary/30 relative">
      {/* Smooth transition overlays - larger zones */}
      <div className="absolute top-0 left-0 right-0 h-64 bg-gradient-to-b from-primary/5 via-primary/5 to-transparent pointer-events-none" />
      <div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-b from-transparent via-secondary/20 to-secondary/30 pointer-events-none" />
